package com.payphone.framework.utils
...
import com.payphone.framework.databinding.WidgetTipsToastBinding

/**
 * create time : 2023/9/26 17:37
 * create by : xupengpeng
 */
class TipsToast private constructor() {

    companion object {
        val instance: TipsToast by lazy(LazyThreadSafetyMode.SYNCHRONIZED) {
            TipsToast()
        }
    }
