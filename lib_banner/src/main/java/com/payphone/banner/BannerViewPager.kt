...
import com.payphone.banner.base.BaseBannerAdapter
import com.payphone.banner.base.BaseBannerAdapter.Companion.MAX_VALUE
import com.payphone.banner.base.BaseViewHolder
import com.payphone.banner.mode.IndicatorGravity.Companion.CENTER
import com.payphone.banner.mode.IndicatorGravity.Companion.END
import com.payphone.banner.mode.IndicatorGravity.Companion.START
import com.payphone.banner.annotation.AIndicatorGravity
import com.payphone.banner.annotation.AIndicatorSlideMode
import com.payphone.banner.annotation.AIndicatorStyle
import com.payphone.banner.annotation.APageStyle
import com.payphone.banner.annotation.Visibility
import com.payphone.banner.indicator.IIndicator
import com.payphone.banner.indicator.IndicatorView
import com.payphone.banner.manager.BannerManager
import com.payphone.banner.manager.ReflectLayoutManager
import com.payphone.banner.mode.PageStyle
import com.payphone.banner.options.BannerOptions
import com.payphone.banner.options.BannerOptions.Companion.DEFAULT_REVEAL_WIDTH
import com.payphone.banner.options.IndicatorOptions
import com.payphone.banner.transform.ScaleInTransformer.Companion.DEFAULT_MIN_SCALE
import com.payphone.banner.utils.BannerUtils
import com.payphone.banner.utils.BannerUtils.getOriginalPosition
import com.payphone.framework.utils.ViewUtils
...
open class BannerViewPager<T, H : BaseViewHolder<T>> @JvmOverloads constructor(
     ...
     *
     *
     * if the indicator style is [com.payphone.banner.mode.IndicatorStyle.DASH]
     * or [com.payphone.banner.mode.IndicatorStyle.ROUND_RECT]
    ...
    /**
     * Set indicator dash width，if indicator style is [com.payphone.banner.mode.IndicatorStyle.CIRCLE],
     * the indicator circle radius is indicatorWidth/2.
     *
     * @param normalWidth if the indicator style is [com.payphone.banner.mode.IndicatorStyle.DASH]
     * the params means unchecked dash width
     * if the indicator style is [com.payphone.banner.mode.IndicatorStyle.ROUND_RECT]  means
     * unchecked round rectangle width
     * if the indicator style is [com.payphone.banner.mode.IndicatorStyle.CIRCLE] means
     * unchecked circle diameter
     * @param checkWidth if the indicator style is [com.payphone.banner.mode.IndicatorStyle.DASH]
     * the params means checked dash width
     * if the indicator style is [com.payphone.banner.mode.IndicatorStyle.ROUND_RECT] the
     ...
     * [com.payphone.banner.mode.IndicatorGravity.CENTER]
     * [com.payphone.banner.mode.IndicatorGravity.START]
     * [com.payphone.banner.mode.IndicatorGravity.END]
     */
    ...
    /**
     * Set Indicator slide mode，default value is [com.payphone.banner.mode.IndicatorSlideMode.NORMAL]
     *
     * @param slideMode Indicator slide mode
     * @see com.payphone.banner.mode.IndicatorSlideMode.NORMAL
     *
     * @see com.payphone.banner.mode.IndicatorSlideMode.SMOOTH
     */
     ...
     * @see com.payphone.banner.mode.IndicatorStyle.CIRCLE
     *
     * @see com.payphone.banner.mode.IndicatorStyle.DASH
     *
     * @see com.payphone.banner.mode.IndicatorStyle.ROUND_RECT
     */
